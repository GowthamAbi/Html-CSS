        ...
        >
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900">
            ...
            <li>
              <a
                href="#"
                className="block py-2 px-3 text-white bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:p-0 dark:bg-blue-600 md:dark:bg-transparent"
              >
                Home
              </a>
            </li>
            ...
            <li className="relative">
              <button
                ...
                className="flex items-center justify-between w-full py-2 px-3 text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:p-0 md:w-auto dark:text-white md:dark:hover:text-blue-500"
              >
                Dropdown
                <svg
              ...
              {/* Dropdown Menu */}
              {isDropdownOpen && (
                <div className="absolute z-10 mt-2 bg-white rounded-lg shadow-md w-44 dark:bg-gray-700">
                  <ul className="py-2 text-sm text-gray-700 dark:text-gray-200">
                    ...
                    <li className="relative">
                      ...
                      {isDoubleDropdownOpen && (
                        <div className="absolute left-full top-0 ml-1 bg-white rounded-lg shadow-md w-44 dark:bg-gray-700">
                          <ul className="py-2 text-sm text-gray-700 dark:text-gray-200">
                            <li>
                              <a
                                href="#"
            ...
            <li>
              <a
                href="#"
                className="block py-2 px-3 text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:text-white md:dark:hover:text-blue-500"
              >
                Services
              </a>
            </li>
